...
Global options:
	...
	-caldav-port example.com
		CalDAV port on which hydroxide listens, defaults to 8443
	-disable-caldav
...
func main() {
	...
	caldavPort := flag.String("caldav-port", "8443", "CalDAV port on which hydroxide listens, defaults to 8443")
